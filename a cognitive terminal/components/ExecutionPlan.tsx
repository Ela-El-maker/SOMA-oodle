...
interface AgentExecutionProps {
    ...
    status: 'Planning...' | 'Executing...' | 'Complete' | 'Failed' | string;
}

const StatusBadge: React.FC<{ status: AgentExecutionProps['status'] }> = ({ status }) => {
...
const LogEntry: React.FC<{ entry: ExecutionLogEntry }> = ({ entry }) => {
    const typeStyles: Record<ExecutionLogEntry['type'], string> = {
    ...
    const icon: Record<ExecutionLogEntry['type'], React.ReactNode> = {
...
export const AgentExecution: React.FC<AgentExecutionProps> = ({ goal, plan, logEntries, status }) => {
