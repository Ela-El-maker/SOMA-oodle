...
import { MarketPoint, PredictionScenario } from '../types';
...
const CandleView: React.FC<CandleViewProps> = ({ data, width, height, predictions }) => {
  const svgRef = useRef<SVGSVGElement>(null);
  const [visibleCount, setVisibleCount] = useState(60); // Default zoom
  const [hoverInfo, setHoverInfo] = useState<MarketPoint | null>(null);
    ...
    <div className="w-full h-full relative group" onWheel={handleWheel}>
      ...
      <div className="absolute top-4 left-4 pointer-events-none">
          <div className="flex flex-col gap-1">
              ...
              {hoverInfo ? (
                  <div className="bg-slate-900/80 backdrop-blur border-l-2 border-market-up p-3 shadow-[0_0_15px_rgba(0,0,0,0.5)]">
                       <div className="flex gap-4 text-xs font-mono">
                           ...
                           <div className="flex flex-col">
                               ...
                               <span className={hoverInfo.close >= hoverInfo.open ? "text-market-up drop-shadow-[0_0_5px_rgba(255,0,255,0.8)]" : "text-cyan-400 drop-shadow-[0_0_5px_rgba(0,255,255,0.8)]"}>
